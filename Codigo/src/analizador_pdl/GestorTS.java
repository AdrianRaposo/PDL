...
public class GestorTS {
	...
	public void generarTS(){
		System.out.println("Creando tabla de símbolos...");
		...
		try {
			...
			bw.close();
			System.out.println("Tabla de símbolos creada con exito.");
		} catch (IOException e) {
			System.err.println("Error al crear la tabla de símbolos.");
