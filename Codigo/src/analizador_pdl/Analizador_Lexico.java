		...
		while(!leido && !this.eof) {
			...
			case 0 :
				if(cTipo.esDelimitador(caracter) || caracter.equals("\r")){
					...
					if(caracter.equals("FinFicher@") && fin==true) {
						...
						gestorErrores.addError(new Errores(nLinea,1,"","léxico"));
						token = null;
			...
			case 4 :
				if(caracter.equals("&")) {
					...
					this.gestorErrores.addError(new Errores(nLinea,2,"","léxico"));
					leido = true;
					token = null;
				}
				break;
			...
			case 6 :
				if(caracter.equals("*")) {
					...
					this.gestorErrores.addError(new Errores(nLinea,3,"","léxico"));
					leido = true;
					token = null;
				}
				break;
			...
			case 8 :
				if(!caracter.equals("*") && !caracter.equals("/") ){
					...
					this.gestorErrores.addError(new Errores(nLinea,4,"","léxico"));
					leido = true;
					token = null;
				}
				break;
			case 9 :
				if(!caracter.equals("\"")&& !fin) {
					...
					this.gestorErrores.addError(new Errores(nLinea,28,"","léxico"));
					leido=true;
					token=null;
				}
				break;
			...
			case 11 :
				if(valor < (int) (Math.pow(2, 16)-1)) {
					...
					this.gestorErrores.addError(new Errores(nLinea,5,"","léxico"));
					leido = true;
					token = null;
				}
				break;
